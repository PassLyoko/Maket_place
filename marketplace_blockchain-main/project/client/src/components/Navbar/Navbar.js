...
const Navbar = (props) => {
  ...
  return (
    ...
    <nav className="navbar">
      <h3 className="logo">
        <Link to="/MainSystem" className="logo"> HALOVI MARKET</Link>
      </h3>
      <ul className={isMobile ? "nav-links-mobile" : "nav-links"}>

        {localStorage.getItem("accessToken")
          ? <>
            <Link to="/MainSystem" className="create">
              <li className="line">Home</li>

            </Link>
            <Link to="/" className="create">
              <li className="line">Product</li>
            </Link>
            <Link to="/createProduct" className="create">
              <li className="line">Item</li>
            </Link>
            <Link to="/Sales" className="create">
              <li className="line"> Sale</li>
            </Link>
            <Link to="/AboutCompany" className="create">
              <li className="line">Abouts</li>
            </Link>
            ...
            <div
              className={!isShowUserLogin ? `dropdown-menu` : `dropdown-menu active`}
            >
